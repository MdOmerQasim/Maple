 ...
 */
package com.maple.frontend.hrAdminScreen;

import com.maple.frontend.eventAdminScreen.*;
...
public class HRAdminScreen extends javax.swing.JPanel {
    ...
    public HRAdminScreen(JSplitPane jSplitPane, ArrayList<User> userData) throws SQLException {
        initComponents();
        ...
        HRAdminDashboard hrAdminDashboard = new HRAdminDashboard(userData);
        jRightSplitPane.setRightComponent(hrAdminDashboard);
    }
...
//        notificationBadge.setBadges(notification); 
    ...
    private void initComponents() {
        ...
        jManageBtn = new com.maple.resources.Button();
        ...
        jManageBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/maple/icons/analytics.png"))); // NOI18N
        jManageBtn.setText("Manage");
        ...
        jBaseLeftPanelLayout.setHorizontalGroup(
            ...
            .addGroup(jBaseLeftPanelLayout.createSequentialGroup()
                ...
                .addGroup(jBaseLeftPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jManageBtn, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//        } catch (SQLException ex) {}
    ...
    private void jManageBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jManageBtnActionPerformed
        ...
        try {
            HRAdminManageScreen hrAdminManageScreen = new HRAdminManageScreen();
            jRightSplitPane.setRightComponent(hrAdminManageScreen);
        } catch (SQLException ex) {
            Logger.getLogger(HRAdminScreen.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//            getNotificationData();
    ...
    private com.maple.resources.Button jManageBtn;
